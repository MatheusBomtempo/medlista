...
const { TextArea } = Input;
        ...
        const onSubimitMedicos = async ()  => {
           try {
            await addDoc(todosMedicos, { nome: novoNome, CRM: novoCRM,especialidade: novaEspecialidade, local: novoLocal, atende: novoAtende, convênio: novoConvenio});
           } catch (err){
            console.error(err)
           }
        }
                ...
                <Row className='justify-content-center'> 
                    <Col xs={12} md={6} xl={5} >
                        ...
                        >
                            ...
                            <Form.Item
                            label="Nome:">
                            <Input size="large" required={true} placeholder="Insira seu Nome" type='text' onChange={(e) => setNovoNome(e.target.value)} />
                            </Form.Item>

                            <Form.Item
                            label="CRM:">
                            <Input size="large" required={true} placeholder="Insira seu CRM" type='number' onChange={(e) => setNovoCRM(e.target.value)} />
                            </Form.Item>
                            ...
                            <Form.Item label="Especialidade">
                                <Select
                                 ...
                                 size="large" placeholder="Insira sua especialidade" >
                                    <Select.Option value="Psiquiatra">Psiquiatra</Select.Option>
                                    <Select.Option value="Oftalmologista">Oftalmologista</Select.Option>
